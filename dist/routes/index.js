...
const categoryRoutes_1 = __importDefault(require("./categoryRoutes/index.js"));
...
router.use('/categories', authenticateJWT_1.authenticateJWT, categoryRoutes_1.default);
